...
(() => {
  ...
  Object.assign(data.brands, {
    ...
    vican: {
      name:'Vinařství Vican', domain:'vican.wine', website:'https://eshop.vican.wine/',
      theme:{brand:'#a8301c',accent:'#b5661a',soft:'#f6efe6',paper:'#fdfaf6',ink:'#231a17',line:'#eadfd3'},
      wordmark:logo('vican','Vinařství Vican'),
      hero:'/assets/vino/vican.jpg', mark:'/assets/vino/vican-mark.png', headerLogo:'/assets/vino/vican-logo-header.png',
      markColor:{reverse:'/assets/vino/vican-mark-reverse.png',bg:'#a8301c',bgHover:'#f6efe6'},
      ownerNote:'Takmer 30 vín z Mikulova — suché biele, Pálava, výbery z cibéb, Merlot, cuvée Jupiter, rosé aj frizzanté — a zákazník nevie, čo si vybrať.',
      benefit:['Z takmer 30 vín to pravé k jedlu','Poradí sladšie, rosé aj frizzanté na oslavu','Odpovie aj mimo otváracích hodín'],
      products:[
        {id:'sylvan',name:'Sylvánské zelené 2025, pozdní sběr, suché',price:'239 Kč',url:'https://eshop.vican.wine/bila-vina/sylvanske-zelene-2025--pozdni-sber--suche/',photo:photo('vican','sylvan'),tags:['white','crisp','fish'],reason:'Svieža vôňa citrusov, citronely a jemných byliniek, v chuti citrusová línia a jemne korenistý záver — k rybám a šalátom.'},
        {id:'sauvignon',name:'Sauvignon 2023, pozdní sběr, suché',price:'239 Kč',url:'https://eshop.vican.wine/bila-vina/sauvignon-2023--pozdni-sber--suche/',photo:photo('vican','sauvignon'),tags:['white','fruity','fish'],reason:'Záhradné ovocie a pŕhľava, šťavnatá ovocná chuť s ľahkým cukrom — vinárstvo ho odporúča k špargli a čerstvému kozímu syru.'},
        {id:'chardonnay',name:'Chardonnay 2023 - edice Karel Roden, výběr z hroznů, suché',price:'315 Kč',url:'https://eshop.vican.wine/bila-vina/chardonnay-2023-edice-karel-roden--vyber-z-hroznu--suche/',photo:photo('vican','chardonnay'),tags:['white','crisp','fish','target'],reason:'Banán, broskyňa a lipový kvet, minerálna chuť s pikantnou kyselinkou — edícia Karel Roden s jeho podpisom na etikete.'},
        {id:'rizling',name:'Ryzlink rýnský 2024, výběr z hroznů, suché',price:'289 Kč',url:'https://eshop.vican.wine/bila-sucha-vina/ryzlink-rynsky-2024--vyber-z-hroznu--suche/',photo:photo('vican','rizling'),tags:['white','bold','fish','target'],reason:'Biele broskyne a lipový kvet s tónom dreva, plná a šťavnatá chuť s dlhou dochuťou — víno, ktoré vydrží aj archiváciu.'},
        {id:'tramin',name:'Tramín červený 2024, výběr z hroznů, polosladké',price:'269 Kč',url:'https://eshop.vican.wine/bila-vina/tramin-cerveny-2024--vyber-z-hroznu--polosladke/',photo:photo('vican','tramin'),tags:['white','sweet','cheese'],reason:'Mohutné zlaté víno s vôňou medu, korenia a ruží, plná chuť s medovým cukrom v závere — k syrom a dezertom.'},
        {id:'palava',name:'Pálava 2024 - edice Karel Roden, výběr z hroznů, polosladké',price:'349 Kč',url:'https://eshop.vican.wine/bila-polosladka-vina/palava-2024-edice-karel-roden--vyber-z-hroznu--polosladke/',photo:photo('vican','palava'),tags:['white','sweet','cheese','target'],reason:'Hrozno, rozkvitnutá lúka a tropické ovocie, v chuti med a korenistosť — vinárstvo ju odporúča k tvarohovým dezertom s marhuľami.'},
        {id:'cibeby',name:'Ryzlink vlašský 2017, výběr z cibéb, sladké (0,25 l)',price:'319 Kč',url:'https://eshop.vican.wine/vina/ryzlink-vlassky-2017--vyber-z-cibeb--sladke/',photo:photo('vican','cibeby'),tags:['white','sweet','cheese','target'],reason:'Z hrozna s ušľachtilou plesňou ako tokajské: med, hrozienka, propolis a sušené ovocie — vzácnosť na aperitív či k dezertu.'},
        {id:'pinot',name:'Rulandské modré 2024 ps, suché',price:'250 Kč',url:'https://eshop.vican.wine/cervena-vina/rulandske-modre-2024-ps--suche/',photo:photo('vican','pinot'),tags:['red','fruity','fish'],reason:'Elegantné víno tehlovej farby, lesné ovocie s decentnou stopou dreva a zamatový, hrejivý záver — ľahké, k hydine aj hubám.'},
        {id:'merlot',name:'Merlot 2023 - Rodinná rezerva, výběr z hroznů, suché',price:'349 Kč',url:'https://eshop.vican.wine/cervena-vina/merlot-2023-rodinna-rezerva--vyber-z-hroznu--suche/',photo:photo('vican','merlot'),tags:['red','fruity','meat','target'],reason:'Marmeláda a višňový kompót, veľmi jemná a zamatová chuť prezretých višní a čerešní s nižšími kyselinami.'},
        {id:'frankovka',name:'Frankovka 2022, pozdní sběr, suché, Moravský akát',price:'249 Kč',url:'https://eshop.vican.wine/cervena-vina/frankovka-2022--pozdni-sber--suche--moravsky-akat/',photo:photo('vican','frankovka'),tags:['red','bold','meat'],reason:'Záhradné ovocie, jemné korenie a drevo, dlhá chuť čerešní a višní s hladkými trieslovinami — k bravčovej panenke v korenistej omáčke.'},
        {id:'jupiter',name:'Cuvée Jupiter 2022, suché',price:'319 Kč',url:'https://eshop.vican.wine/vina/cuvee-jupiter-2022--suche/',photo:photo('vican','jupiter'),tags:['red','bold','meat','target'],reason:'Višne v čokoláde a jemný dotyk cigary, plná a mimoriadne dlhá chuť — hrozno naň zbierali priaznivci vinárstva.'},
        {id:'the',name:'Cuvée Thé rosé 2022, mzv, polosuché',price:'199 Kč',url:'https://eshop.vican.wine/ruzova-vina/cuvee-the-rose-2022--mzv--polosuche/',photo:photo('vican','the'),tags:['rose','fruity','cheese'],reason:'Frankovka a Cabernet Sauvignon: svieža ruža, ovocie a jemné sladké korenie — k ovocnému šalátu s kozím syrom.'},
        {id:'rose',name:'Cabernet Sauvignon ROSÉ 2025 kabinetní, polosladké',price:'219 Kč',url:'https://eshop.vican.wine/ruzova-polosladka-vina/cabernet-sauvignon-rose-2025-kabinetni--polosladke/',photo:photo('vican','rose'),tags:['rose','sweet','fish'],reason:'Drobné lesné ovocie a výrazná červená ríbezľa so sviežou kyselinkou a jemným zvyškovým cukrom — na leto a k ľahkým jedlám.'},
        {id:'frizzmuskat',name:'Frizzanté Muškát žlutý 2025, polosuché',price:'269 Kč',url:'https://eshop.vican.wine/vina/frizzante-muskat-zluty-2025--polosuche/',photo:photo('vican','frizzmuskat'),tags:['sparkling','fruity','fish'],reason:'Jemne perlivé víno so sviežou citrusovo-muškátovou vôňou, sýtené prírodným CO₂ z kvasiaceho vína — na prípitok aj do letných kokteilov.'},
        {id:'frizzpalava',name:'Frizzanté Pálava 2025, polosladké',price:'269 Kč',url:'https://eshop.vican.wine/vina/frizzante-palava-2025--polosladke/',photo:photo('vican','frizzpalava'),tags:['sparkling','sweet','cheese','target'],reason:'Exotické ovocie a jemne medová chuť s hravým perlením — vinárstvo ju odporúča na letné večery a k sladkým dezertom.'}
      ]
    },
    valka: {
      name:'Vinařství Válka', domain:'vinarstvivalka.cz', website:'https://vinarstvivalka.cz/',
      theme:{brand:'#af193e',accent:'#7f122d',soft:'#f7f0ee',paper:'#fdfafa',ink:'#231a1c',line:'#ecdfe0'},
      wordmark:logo('valka','Vinařství Válka'),
      hero:'/assets/vino/valka.jpg', mark:'/assets/vino/valka-mark.png', headerLogo:'/assets/vino/valka-logo-header.png',
      markColor:{reverse:'/assets/vino/valka-mark-reverse.png',bg:'#af193e',bgHover:'#f7f0ee'},
      ownerNote:'Vyše 30 BIO vín z Nosislavi — suché biele, oranžové, rosé, pet-naty aj Jantar v štýle sherry — a zákazník nevie, čím začať.',
      benefit:['Z vyše 30 BIO vín to pravé k jedlu','Vysvetlí oranžové víno aj pet-nat','Odpovie aj mimo otváracích hodín'],
      products:[
        {id:'veltlin',name:'Veltlínské zelené 2023, suché, BIO',price:'249 Kč',url:'https://vinarstvivalka.cz/produkt/veltlinske-zelene-2023-suche-bio/',photo:photo('valka','veltlin'),tags:['white','crisp','fish'],reason:'Jemná vôňa žltého ovocia a pomarančových kvetov, šťavnatá chuť plná čerstvého ovocia a korenistý záver s náznakom minerality.'},
        {id:'vlassky',name:'Ryzlink vlašský 2023, Terasy, suché, BIO',price:'250 Kč',url:'https://vinarstvivalka.cz/produkt/ryzlink-vlassky-2023-terasy-suche-bio/',photo:photo('valka','vlassky'),tags:['white','crisp','fish'],reason:'Kôstkové ovocie a žlté jablko s príjemnou kyselinkou, výraznou mineralitou a jemnou slanosťou v dochuti — s ľahkým dotykom suda.'},
        {id:'chardonnay',name:'Chardonnay 2023, suché, BIO',price:'219 Kč',url:'https://vinarstvivalka.cz/produkt/chardonnay-2023-suche-bio/',photo:photo('valka','chardonnay'),tags:['white','fruity','fish'],reason:'Rozkvitnutá letná lúka a šťavnaté pomelo, jemná ovocná chuť so zaguľatenou kyselinkou a dlhou dochuťou hrušiek a žltého jablka.'},
        {id:'palava',name:'Pálava 2025, suché, BIO',price:'285 Kč',url:'https://vinarstvivalka.cz/produkt/palava-2025-suche-bio/',photo:photo('valka','palava'),tags:['white','fruity','cheese'],reason:'Voňavá Pálava s tónom ovocia a ruže, no v chuti suchá a osviežujúca — broskyne a červené jablká s dlhou dochuťou.'},
        {id:'rizling',name:'Ryzlink rýnský 2023, suché, BIO',price:'285 Kč',url:'https://vinarstvivalka.cz/produkt/ryzlink-rynsky-2023-suche-bio/',photo:photo('valka','rizling'),tags:['white','bold','fish','target'],reason:'Komplexný Rizling, ktorý zrel 20 mesiacov vo veľkom drevenom sude: sadové ovocie, nádych medu, uhladená kyselinka a dlhá dochuť.'},
        {id:'orange',name:'Pálava oranžová 2024, suché, BIO',price:'430 Kč',url:'https://vinarstvivalka.cz/produkt/palava-oranzova-2024-suche-bio/',photo:photo('valka','orange'),tags:['white','bold','cheese','target'],reason:'Oranžové víno z macerovanej Pálavy: trochu triesla a suda, jazmín, pomaranče a sušené ovocie, plné telo a hladký záver.'},
        {id:'bilafrankovka',name:'Bílá Frankovka 2024, polosuché, BIO',price:'269 Kč',url:'https://vinarstvivalka.cz/produkt/bila-frankovka-2024-polosuche-bio/',photo:photo('valka','bilafrankovka'),tags:['rose','fruity','fish'],reason:'Svetlý klaret z Frankovky: maliny, čučoriedky a lesné jahody s medovkou a citrónovou kôrou, ľahká šťavnatá chuť červeného grepu.'},
        {id:'rose',name:'Cabernet Moravia rosé 2024, suché, BIO',price:'225 Kč',url:'https://vinarstvivalka.cz/produkt/cabernet-moravia-rose-2024-suche-bio/',photo:photo('valka','rose'),tags:['rose','crisp','fish'],reason:'Elegantné rosé plné zrelých malín a čerešní, svieže s korenistou dochuťou — plnšie ružové na každý deň.'},
        {id:'laguerre',name:'La Guerre rosé 2022, suché, BIO',price:'219 Kč',url:'https://vinarstvivalka.cz/produkt/cuvee-la-guerre-rose-2022-suche/',photo:photo('valka','laguerre'),tags:['rose','fruity','meat'],reason:'Frankovka a Cabernet Moravia: šťavnaté aj korenisté, lesné ovocie, kompótovaná višňa a smotanové tóny — nefiltrované, ku grilu.'},
        {id:'rysak',name:'Nosislavský ryšák 2022, suché, BIO',price:'219 Kč',url:'https://vinarstvivalka.cz/produkt/nosislavsky-rysak-2022-suche-bio/',photo:photo('valka','rysak'),tags:['rose','fruity','fish'],reason:'Svätovavrinecké, Cabernet Moravia a Chardonnay: ovocné, ľahké a svieže víno s jahodami a malinami, no s plnou dochuťou.'},
        {id:'frankovka',name:'Frankovka 2022, suché, BIO',price:'249 Kč',url:'https://vinarstvivalka.cz/produkt/frankovka-2022-suche-bio/',photo:photo('valka','frankovka'),tags:['red','fruity','meat'],reason:'Živá, šťavnatá Frankovka: tmavé lesné ovocie, korenie, bylinky a vanilka, elegantné triesloviny a dlhá dochuť.'},
        {id:'samet',name:'Černý samet 2022, suché, BIO',price:'249 Kč',url:'https://vinarstvivalka.cz/produkt/cerny-samet-suche-2022-bio/',photo:photo('valka','samet'),tags:['red','bold','meat'],reason:'Svätovavrinecké s Alibernetom: sýta farba, ostružiny a slivky s dotykom dreva, zamatová chuť — víno takmer bez síry.'},
        {id:'pinot',name:'Pinot Noir 2021/2022, suché, BIO, Family Reserve',price:'349 Kč',url:'https://vinarstvivalka.cz/produkt/pinot-noir-2021-2022-suche-bio/',photo:photo('valka','pinot'),tags:['red','fruity','fish','target'],reason:'Živý, ľahký a ovocný Pinot z dubových sudov: korenie, pečené ovocie a zamatové triesloviny — ku kačke, hydine aj hubám.'},
        {id:'cabernet',name:'Cabernet Sauvignon 2021, suché, BIO',price:'430 Kč',url:'https://vinarstvivalka.cz/produkt/cabernet-sauvignon-2021-bio/',photo:photo('valka','cabernet'),tags:['red','bold','meat','target'],reason:'Sila a elegancia: čierne čerešne, ostružiny a škorica, barikový sud a dlhá dochuť — nefiltrované víno s potenciálom zrenia.'},
        {id:'jantar',name:'Jantar z Výhonu 2020, polosuché, BIO',price:'430 Kč',url:'https://vinarstvivalka.cz/produkt/jantar-2020-polosuche-dezertni-vino-bio/',photo:photo('valka','jantar'),tags:['red','sweet','cheese','target'],reason:'Dezertné víno z Cabernetu Moravia zberaného pri −8 °C, dva roky v dubovom sude, v štýle sherry: čerešne, vanilka, marhuľový kompót a kandizovaná višňa.'},
        {id:'muau',name:'MuAu Pet-Nat 2025, brut natur, perlivé, BIO',price:'335 Kč',url:'https://vinarstvivalka.cz/produkt/muau-pet-nat-2025-brut-natur-perlive-bio-2/',photo:photo('valka','muau'),tags:['sparkling','crisp','fish'],reason:'Aurelius a Muškát: divoký, svieži a ovocný pet-nat — citrusy, orechy, lúka a jablko s osviežujúcou kyselinkou. Podávať dobre vychladený.'},
        {id:'blau',name:'BLAU Pet-Nat 2025, brut natur, perlivé, BIO',price:'335 Kč',url:'https://vinarstvivalka.cz/produkt/blau-pet-nat-2025-brut-natur-perlive-bio/',photo:photo('valka','blau'),tags:['sparkling','fruity','fish'],reason:'Svieži Pinot Noir v podobe pet-natu, ktorý sa pije ako malinovka — jahody a citrusy, letná vec do pohára.'}
      ]
    }
  });
})();
