...
* assets/vino/SLUG-ID.jpg  760x1095 packshot, trimmed and centred on white
  so neither the portrait result card nor the landscape option tile cuts it.
* assets/vino/SLUG.jpg     1000x1120 hero: first four packshots as 2x2
  white tiles on the brand's soft colour (same geometry as the older demos).
* assets/vino/SLUG-logo.png transparent logo, trimmed.
"""
import sys
from pathlib import Path
from PIL import Image, ImageChops, ImageOps

OUT = Path(__file__).resolve().parent.parent / 'assets' / 'vino'
