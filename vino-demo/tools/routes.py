...
vercel = {
    ...
    'rewrites': [
        ...
        {'source': '/vino/:slug', 'destination': '/cosmetics.html'},
        {'source': '/vino/:slug/', 'destination': '/cosmetics.html'},
    ],
    'headers': [
...
# /vino/<slug> works too; the page reads the slug from the path.
RewriteRule ^vino/[a-z0-9-]+/?$ cosmetics.html [L,NC]
...
<title>Ukážky pre vinárstva</title>
...
<body>
  <main>
    <h1>Ukážky pre vinárstva</h1>
    <p>Chatbot a výber vína pre {len(brands)} vinárstiev.</p>
    <ul>
{cards}
    </ul>
  </main>
