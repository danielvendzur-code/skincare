(() => {
  ...
  /* Hair segment: the same four steps and the same answer tokens as the
     skincare advisor (scoring, routine and result code read the tokens), with
     questions, labels and photographs about hair. */
  const photo = (value) => `/assets/vlasy/choice-${value}.jpg`;
  const semanticPhotos = Object.fromEntries(
    ['dry','oily','sensitive','balanced','hydrate','calm','clarity','mature','simple','basic','full','target','cream','serum','oil','any']
      .map((value) => [value, photo(value)])
  );

  const questions = [
    { key:'skin', kicker:'Vaše vlasy', title:'Aké sú vaše vlasy a pokožka hlavy?', options:[
      {value:'dry',title:'Suché a lámavé',text:'Krepovatejú, chýba im lesk',image:semanticPhotos.dry},
      {value:'oily',title:'Rýchlo sa mastia',text:'Mastná pokožka, vlasy bez objemu',image:semanticPhotos.oily},
      {value:'sensitive',title:'Citlivá pokožka hlavy',text:'Svrbí, šupinky alebo lupiny',image:semanticPhotos.sensitive},
      {value:'balanced',title:'Normálne vlasy',text:'Bez jedného výrazného problému',image:semanticPhotos.balanced}
    ]},
    { key:'goal', kicker:'Priorita', title:'Čo chcete riešiť ako prvé?', options:[
      {value:'hydrate',title:'Výživu a lesk',text:'Hebké vlasy, ľahšie rozčesávanie',image:semanticPhotos.hydrate},
      {value:'calm',title:'Upokojiť pokožku',text:'Svrbenie, lupiny, podráždenie',image:semanticPhotos.calm},
      {value:'clarity',title:'Objem a sviežosť',text:'Dlhšie čisté a ľahké vlasy',image:semanticPhotos.clarity},
      {value:'mature',title:'Posilnenie vlasov',text:'Vypadávanie, rednutie, slabé vlasy',image:semanticPhotos.mature}
    ]},
    { key:'routine', kicker:'Rutina', title:'Koľko krokov vám reálne vyhovuje?', options:[
      ...
      {value:'basic',title:'2–3 kroky',text:'Šampón a starostlivosť k nemu',image:semanticPhotos.basic},
      {value:'full',title:'Kompletná starostlivosť',text:'Umývanie, dĺžky aj pokožka',image:semanticPhotos.full},
      {value:'target',title:'Len niečo doplniť',text:'Hľadám jeden cielený krok',image:semanticPhotos.target}
    ]},
    { key:'texture', kicker:'Forma', title:'Aký produkt hľadáte?', options:[
      {value:'cream',title:'Šampón',text:'Umývanie – základ starostlivosti',image:semanticPhotos.cream},
      {value:'serum',title:'Sérum alebo tonikum',text:'Ľahko, priamo na pokožku hlavy',image:semanticPhotos.serum},
      {value:'oil',title:'Starostlivosť o dĺžky',text:'Kondicionér, maska alebo olej',image:semanticPhotos.oil},
